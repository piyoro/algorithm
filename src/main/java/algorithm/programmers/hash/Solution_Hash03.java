...
public class Solution_Hash03 {
	...
	/**
	 * <pre>
	 * hash 를 이용하여 부위별 의상갯수를 모두 구하고, 각 부위요수 마다 다음 부위의 경우의 수에 대한 계산을 
	 * 재귀함수 호출을 이용해서 계산하면 간단하게 구해질거라 생각했다. 
	 * 주어진 테스트케이스가 상당히 빈약해서.. 경우의 수를 손으로 계산하고 
	 * 적당히 3가지 부위 3가지 의상으로 계산했을 때 답은 맞았다. 
	 * 테스트케이스 제공이 너무 부족하다고 혼자 속앓이만 했다.
	 * </pre>
	 * 
	 * @param clothes
	 * @return
